...
✅ Resolved:
1. Dataset splits: 70-15-15 train/val/test
2. Class weights calculated globally
3. Cloud detection handled in preprocessing
4. CUDA environment verified (RTX 4090)
5. Working directory: /home/colm-the-conjurer/VSCode/workspace/LoveDA-Benchmarking
LoveDA Semantic Segmentation Benchmark
